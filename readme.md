...
Original source: https://github.com/android/connectivity-samples/tree/main/BluetoothAdvertisements

Note: I changed the code slightly to make the app runnable on modern Android version (tested on Android 12).

In AndroidManifest.xml I'm added some permissions and in MainActivity.java I added a runtime permission check 
to grant the permissions.

The last change did happen in AdvertiserFragment.java where the PendingIntent and Notification builder needed 
a major change to run.
